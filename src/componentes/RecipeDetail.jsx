    ...
    <div className="bg-gray-100">
      <div className="container mx-auto py-12 px-4">
        <div className="bg-white rounded-lg shadow-lg overflow-hidden">
          ...
          <div className="p-6">
            <h2 className="text-4xl font-semibold text-black mb-4">{recipe.title}</h2>
            ...
            <div className="mb-6">
              <h3 className="text-2xl font-semibold text-black mb-2">Descripción:</h3>
              {recipe.description.map((paragraph, i) => (
                <p key={i} className="text-gray-800 text-base">{paragraph}</p>
              ))}
            </div>
            <div className="mb-6">
              <h3 className="text-2xl font-semibold text-black mb-4">Ingredientes:</h3>
              <ul>
              ...
              <ul>
              <h3 className="text-2xl font-semibold text-black mb-4">Instrucciones:</h3>
            ...
            <div className="text-center">
              <Link to="/recipes">
                <button className="bg-gray-800 hover:bg-gray-900 text-white font-semibold py-2 px-6 rounded-full focus:outline-none focus:ring-2 focus:ring-gray-800 active:bg-gray-700">
                  Volver a recetas
                </button>
              </Link>
            </div>
